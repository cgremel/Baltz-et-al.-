...
%total_mice = size(Data.Day(1).Mouse,2);
...
for i = 1:day_number %outer loop goes across days  
    for j = 1:total_mice %inner loop goes across mice within a day        
     ...
     ID = Data.Day(i).Mouse(j).Name(15:18);
...
%add in criteria %
table_or_r2.criteria = criteria_percent_indicator_All;
%using complex LMEs
...
writetable(table_of_r2,'MD-DMS_1600_ctl.csv','QuoteStrings',true) %save table as
...
%Sham IDs
Control_mice = {'4953', '5101', '5102', '5196', '5107', '5188', '5189', '5479', '5480', '5483', '5486', '5495' '5498'}; %Sham
% Lesion IDs
Exp_mice = {'4945', '5100', '5193', '5108', '5190', '5191', '5487', '5488', '5482', '5484'}; %DREADD
% 
%% PV IDS
% % YFP IDs
%Control_mice = {};
