...
Experiment_name = 'EXP107-10shuff-800-1600-all'; % Name of experiment (will be named of saved .mat for all of the following)
PathName_Master = 'G:\EXP 107.1 DS lesions during HD\107.1 for matlab\800 & 1600 all';
...
num_shuff = 10; % # of shuffled data iterations to compare regression results agaisnt
