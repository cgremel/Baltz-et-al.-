...
figure('Name','total session','NumberTitle','off','Position',[100, 100, 800, 400])
hold on;
p1 = plot(GCAMP.gcampdata_timestamps, GCAMP.LED1,'color',red,'LineWidth',1);
...
figure
p4 = plot(time,delta_F_p,'color',gray1,'LineWidth',1);
%% Mean First Head Entry After Reward Delta F percentage plot
% 
% y1 = smoothdata(GCAMP.delta_f_First_HE_After_RE,2,smooth_type,smooth_win);
% n1 = size(y1,1);
% 
% figure('Name',[GCAMP.training_day(1:4) ' Z Criteria FirstHE'],'NumberTitle','off','rend','painters','pos',[100 100 size_w size_h])
% hold on
...
% ylim([-1.5 2.0])
% 
% %% Mean First Head Entry no reward  plot
% 
% y1 = smoothdata(GCAMP.baseline_norm_First_HE_After_Fail,2,smooth_type,smooth_win);
% n1 = size(y1,1);
% 
% figure('Name',[GCAMP.training_day(1:4) ' Z Criteria FirstHE'],'NumberTitle','off','rend','painters','pos',[100 100 size_w size_h])
% hold on
...
figure('Name',[GCAMP.training_day(1:4) ' session'],'NumberTitle','off','rend','painters','pos',[100 100 size_w size_h])
hold on
