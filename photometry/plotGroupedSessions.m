...
smooth_win = 20; %smoothing to make it visually comprehensible
smooth_win_limited = 10;
interp_smooth_win = 1; %smaller because fewer data points
smooth_type = 'sgolay'; %can use Makima for more fidelity of orig signal
y_onset = [-0.5 2.0];
y_offset = [-0.5 2.0];
y_interp = [-0.5 2.0];
y_headentry = [-0.5 6.0];
x_onset = [-2 .1]; %lp onset X values
x_offset = [-.1 5]; %end of LP
